    ...
    <div>
    	...
    	<table class="responsive-table" style="width: 100%; height: 100%; display: block; overflow-x: scroll; white-space: nowrap;">
            ...
            <tr>
                ...
                $GetDataCountPerDate_palangkaraya = $this->db->query("SELECT count(*) AS total_per_date FROM tb_hedsurv AS a INNER JOIN tb_surv AS b ON a.id_surv=b.id_surv WHERE a.tipe_cust = '1' AND a.id_respon = '6' AND a.tgl_telp = '".$joinLoopDate."' AND b.id_comp = '14' ")->result();
            ...
            <tr>
                ...
                $joinLoopDate = $joinYearMonth.$i;
                $MyLibraryHoliday_palangkaraya = array($LibraryMy->getHoliday($joinLoopDate));
                $GetDataCountPerDate_palangkaraya = $this->db->query("SELECT count(*) AS total_per_date FROM tb_hedsurv AS a INNER JOIN tb_surv AS b ON a.id_surv=b.id_surv WHERE a.tipe_cust = '2' AND a.id_respon = '6' AND a.tgl_telp = '".$joinLoopDate."' AND b.id_comp = '14' ")->result();
                foreach ($GetDataCountPerDate_palangkaraya as $row_total_palangkaraya) {
                    $GetTotalPerPalangkaraya = $row_total_palangkaraya->total_per_date;
                }
                if($GetTotalPerPalangkaraya <= 0 || $GetTotalPerPalangkaraya == ''){
    		...
    		<tr>
                ...
                $joinAryTest = array($ArySubSalesTotal_Ahmadyani, $ArySubServiceTotal_Ahmadyani, $ArySubSalesTotal_Martapura, $ArySubServiceTotal_Martapura, $ArySubSalesTotal_Pelaihari, $ArySubServiceTotal_Pelaihari, $ArySubSalesTotal_Palangkaraya, $ArySubServiceTotal_Palangkaraya, $ArySubSalesTotal_Pangkalanbun, $ArySubServiceTotal_Pangkalanbun);
