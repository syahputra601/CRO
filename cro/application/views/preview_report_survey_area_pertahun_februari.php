...
<h2 style="text-align: center;">Bulan Februari Tahun <?= @$get_year_filter ?></h2>
...
foreach($DataCompanyAreaCabang as $row_company){
  ...
  foreach($DataCabang as $row_cabang){
    ...
    //   echo "<br>";
    // }
    $join_month_year = $get_year_filter.'-02';//for februari
    // print_r($join_month_year);
    // echo "<br>";
    $DataReportBulanan = $this->db->query("SELECT COUNT(c.kode_kantor) AS jml_data_area, COUNT(e.type) AS jml_data, a.nama_cust, c.kode_kantor, a.id_comp, c.nama AS nama_cabang, c.kota, e.no_type, e.type, e.quest, e.nm_quest, COUNT(IF(d.nilai = '0', 0, NULL)) 'Kosong', COUNT(IF(d.nilai = '1', 0, NULL)) 'Pertama', COUNT(IF(d.nilai = '2', 0, NULL)) 'Dua', COUNT(IF(d.nilai = '3', 0, NULL)) 'Tiga', COUNT(IF(d.nilai = '4', 0, NULL)) 'Empat', COUNT(IF(d.nilai = '5', 0, NULL)) 'Lima', COUNT(IF(d.nilai = '6', 0, NULL)) 'Enam', COUNT(IF(d.nilai = '7', 0, NULL)) 'Tujuh', COUNT(IF(d.nilai = '8', 0, NULL)) 'Delapan', COUNT(IF(d.nilai = '9', 0, NULL)) 'Sembilan', COUNT(IF(d.nilai = '10', 0, NULL)) 'Sepuluh', (SUM(0)+SUM(1)) AS Total, (SUM('0')+SUM('3')) AS Total_A FROM tb_surv AS a INNER JOIN tb_hedsurv AS b ON a.id_surv = b.id_surv INNER JOIN mst_company AS c ON a.id_comp = c.id_company INNER JOIN tb_detsurv AS d ON a.id_surv = d.id_surv INNER JOIN mst_quest AS e ON d.id_quest = e.id_quest WHERE c.kode_kantor = '".$KodeKantor."' AND c.nama = '".$CabangNama."' AND b.id_respon = '6' AND a.tgl_inv LIKE '%".$join_month_year."%' GROUP BY d.id_quest ORDER BY a.tipe_cust ASC, e.no_type ASC")->result();
...
if(@$cek_emptydata_new == 0){
  echo "<center><p style='color:red;'>Tidak Ada Laporan Survey Semua Area Pada Bulan Februari.</p></center>";
//start coding bagian hitung Rata-Rata
  //start for service
...
<!-- <input type="text" name="txt_Rata_rata_ServiceNoType_1" id="txt_Rata_rata_ServiceNoType_1" value="<?= @$Rata_rata_ServiceNoType_1 ?>" readonly>
<input type="text" name="txt_Rata_rata_ServiceNoType_2" id="txt_Rata_rata_ServiceNoType_2" value="<?= @$Rata_rata_ServiceNoType_2 ?>" readonly>
<input type="text" name="txt_Rata_rata_ServiceNoType_3" id="txt_Rata_rata_ServiceNoType_3" value="<?= @$Rata_rata_ServiceNoType_3 ?>" readonly>
<input type="text" name="txt_Rata_rata_ServiceNoType_4" id="txt_Rata_rata_ServiceNoType_4" value="<?= @$Rata_rata_ServiceNoType_4 ?>" readonly>
<br>
<input type="text" name="txt_Rata_rata_SalesNoType_1" id="txt_Rata_rata_SalesNoType_1" value="<?= @$Rata_rata_SalesNoType_1 ?>" readonly>
<input type="text" name="txt_Rata_rata_SalesNoType_2" id="txt_Rata_rata_SalesNoType_2" value="<?= @$Rata_rata_SalesNoType_2 ?>" readonly>
<input type="text" name="txt_Rata_rata_SalesNoType_3" id="txt_Rata_rata_SalesNoType_3" value="<?= @$Rata_rata_SalesNoType_3 ?>" readonly>
<input type="text" name="txt_Rata_rata_SalesNoType_4" id="txt_Rata_rata_SalesNoType_4" value="<?= @$Rata_rata_SalesNoType_4 ?>" readonly> -->
<?php
}else{
...
?>
<!-- START VERSION OLD -->
<input type="hidden" name="txt_Rata_rata_ServiceNoType_1_februari" id="txt_Rata_rata_ServiceNoType_1_februari" value="<?= $Fix_Rata_rata_ServiceNoType_1 ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_2_februari" id="txt_Rata_rata_ServiceNoType_2_februari" value="<?= @$Fix_Rata_rata_ServiceNoType_2 ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_3_februari" id="txt_Rata_rata_ServiceNoType_3_februari" value="<?= @$Fix_Rata_rata_ServiceNoType_3 ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_4_februari" id="txt_Rata_rata_ServiceNoType_4_februari" value="<?= @$Fix_Rata_rata_ServiceNoType_4 ?>" readonly>
<!-- <br> -->
<input type="hidden" name="txt_Rata_rata_SalesNoType_1_februari" id="txt_Rata_rata_SalesNoType_1_februari" value="<?= @$Fix_Rata_rata_SalesNoType_1 ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_2_februari" id="txt_Rata_rata_SalesNoType_2_februari" value="<?= @$Fix_Rata_rata_SalesNoType_2 ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_3_februari" id="txt_Rata_rata_SalesNoType_3_februari" value="<?= @$Fix_Rata_rata_SalesNoType_3 ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_4_februari" id="txt_Rata_rata_SalesNoType_4_februari" value="<?= @$Fix_Rata_rata_SalesNoType_4 ?>" readonly>
<!-- END VERSION OLD -->
<!-- START BAGIAN TEXT INPUT -->
  <!-- START FOR JAKARTA -->
<input type="hidden" name="txt_Rata_rata_ServiceNoType_1_februari_jkt" id="txt_Rata_rata_ServiceNoType_1_februari_jkt" value="<?= $Fix_Rata_rata_ServiceNoType_1_jkt ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_2_februari_jkt" id="txt_Rata_rata_ServiceNoType_2_februari_jkt" value="<?= @$Fix_Rata_rata_ServiceNoType_2_jkt ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_3_februari_jkt" id="txt_Rata_rata_ServiceNoType_3_februari_jkt" value="<?= @$Fix_Rata_rata_ServiceNoType_3_jkt ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_4_februari_jkt" id="txt_Rata_rata_ServiceNoType_4_februari_jkt" value="<?= @$Fix_Rata_rata_ServiceNoType_4_jkt ?>" readonly>
<!-- <br> -->
<input type="hidden" name="txt_Rata_rata_SalesNoType_1_februari_jkt" id="txt_Rata_rata_SalesNoType_1_februari_jkt" value="<?= @$Fix_Rata_rata_SalesNoType_1_jkt ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_2_februari_jkt" id="txt_Rata_rata_SalesNoType_2_februari_jkt" value="<?= @$Fix_Rata_rata_SalesNoType_2_jkt ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_3_februari_jkt" id="txt_Rata_rata_SalesNoType_3_februari_jkt" value="<?= @$Fix_Rata_rata_SalesNoType_3_jkt ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_4_februari_jkt" id="txt_Rata_rata_SalesNoType_4_februari_jkt" value="<?= @$Fix_Rata_rata_SalesNoType_4_jkt ?>" readonly>
  <!-- END FOR JAKARTA -->
  <!-- START FOR KALTIM -->
<input type="hidden" name="txt_Rata_rata_ServiceNoType_1_februari_kaltim" id="txt_Rata_rata_ServiceNoType_1_februari_kaltim" value="<?= $Fix_Rata_rata_ServiceNoType_1_kaltim ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_2_februari_kaltim" id="txt_Rata_rata_ServiceNoType_2_februari_kaltim" value="<?= @$Fix_Rata_rata_ServiceNoType_2_kaltim ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_3_februari_kaltim" id="txt_Rata_rata_ServiceNoType_3_februari_kaltim" value="<?= @$Fix_Rata_rata_ServiceNoType_3_kaltim ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_4_februari_kaltim" id="txt_Rata_rata_ServiceNoType_4_februari_kaltim" value="<?= @$Fix_Rata_rata_ServiceNoType_4_kaltim ?>" readonly>
<!-- <br> -->
<input type="hidden" name="txt_Rata_rata_SalesNoType_1_februari_kaltim" id="txt_Rata_rata_SalesNoType_1_februari_kaltim" value="<?= @$Fix_Rata_rata_SalesNoType_1_kaltim ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_2_februari_kaltim" id="txt_Rata_rata_SalesNoType_2_februari_kaltim" value="<?= @$Fix_Rata_rata_SalesNoType_2_kaltim ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_3_februari_kaltim" id="txt_Rata_rata_SalesNoType_3_februari_kaltim" value="<?= @$Fix_Rata_rata_SalesNoType_3_kaltim ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_4_februari_kaltim" id="txt_Rata_rata_SalesNoType_4_februari_kaltim" value="<?= @$Fix_Rata_rata_SalesNoType_4_kaltim ?>" readonly>
  <!-- END FOR KALTIM -->
  <!-- START FOR KALBAR -->
<input type="hidden" name="txt_Rata_rata_ServiceNoType_1_februari_kalbar" id="txt_Rata_rata_ServiceNoType_1_februari_kalbar" value="<?= $Fix_Rata_rata_ServiceNoType_1_kalbar ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_2_februari_kalbar" id="txt_Rata_rata_ServiceNoType_2_februari_kalbar" value="<?= @$Fix_Rata_rata_ServiceNoType_2_kalbar ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_3_februari_kalbar" id="txt_Rata_rata_ServiceNoType_3_februari_kalbar" value="<?= @$Fix_Rata_rata_ServiceNoType_3_kalbar ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_4_februari_kalbar" id="txt_Rata_rata_ServiceNoType_4_februari_kalbar" value="<?= @$Fix_Rata_rata_ServiceNoType_4_kalbar ?>" readonly>
<!-- <br> -->
<input type="hidden" name="txt_Rata_rata_SalesNoType_1_februari_kalbar" id="txt_Rata_rata_SalesNoType_1_februari_kalbar" value="<?= @$Fix_Rata_rata_SalesNoType_1_kalbar ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_2_februari_kalbar" id="txt_Rata_rata_SalesNoType_2_februari_kalbar" value="<?= @$Fix_Rata_rata_SalesNoType_2_kalbar ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_3_februari_kalbar" id="txt_Rata_rata_SalesNoType_3_februari_kalbar" value="<?= @$Fix_Rata_rata_SalesNoType_3_kalbar ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_4_februari_kalbar" id="txt_Rata_rata_SalesNoType_4_februari_kalbar" value="<?= @$Fix_Rata_rata_SalesNoType_4_kalbar ?>" readonly>
  <!-- END FOR KALBAR -->
  <!-- START FOR KALSEL -->
<input type="hidden" name="txt_Rata_rata_ServiceNoType_1_februari_kalsel" id="txt_Rata_rata_ServiceNoType_1_februari_kalsel" value="<?= $Fix_Rata_rata_ServiceNoType_1_kalsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_2_februari_kalsel" id="txt_Rata_rata_ServiceNoType_2_februari_kalsel" value="<?= @$Fix_Rata_rata_ServiceNoType_2_kalsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_3_februari_kalsel" id="txt_Rata_rata_ServiceNoType_3_februari_kalsel" value="<?= @$Fix_Rata_rata_ServiceNoType_3_kalsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_4_februari_kalsel" id="txt_Rata_rata_ServiceNoType_4_februari_kalsel" value="<?= @$Fix_Rata_rata_ServiceNoType_4_kalsel ?>" readonly>
<!-- <br> -->
<input type="hidden" name="txt_Rata_rata_SalesNoType_1_februari_kalsel" id="txt_Rata_rata_SalesNoType_1_februari_kalsel" value="<?= @$Fix_Rata_rata_SalesNoType_1_kalsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_2_februari_kalsel" id="txt_Rata_rata_SalesNoType_2_februari_kalsel" value="<?= @$Fix_Rata_rata_SalesNoType_2_kalsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_3_februari_kalsel" id="txt_Rata_rata_SalesNoType_3_februari_kalsel" value="<?= @$Fix_Rata_rata_SalesNoType_3_kalsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_4_februari_kalsel" id="txt_Rata_rata_SalesNoType_4_februari_kalsel" value="<?= @$Fix_Rata_rata_SalesNoType_4_kalsel ?>" readonly>
  <!-- END FOR KALSEL -->
  <!-- START FOR SUMSEL -->
<input type="hidden" name="txt_Rata_rata_ServiceNoType_1_februari_sumsel" id="txt_Rata_rata_ServiceNoType_1_februari_sumsel" value="<?= $Fix_Rata_rata_ServiceNoType_1_sumsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_2_februari_sumsel" id="txt_Rata_rata_ServiceNoType_2_februari_sumsel" value="<?= @$Fix_Rata_rata_ServiceNoType_2_sumsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_3_februari_sumsel" id="txt_Rata_rata_ServiceNoType_3_februari_sumsel" value="<?= @$Fix_Rata_rata_ServiceNoType_3_sumsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_4_februari_sumsel" id="txt_Rata_rata_ServiceNoType_4_februari_sumsel" value="<?= @$Fix_Rata_rata_ServiceNoType_4_sumsel ?>" readonly>
<!-- <br> -->
<input type="hidden" name="txt_Rata_rata_SalesNoType_1_februari_sumsel" id="txt_Rata_rata_SalesNoType_1_februari_sumsel" value="<?= @$Fix_Rata_rata_SalesNoType_1_sumsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_2_februari_sumsel" id="txt_Rata_rata_SalesNoType_2_februari_sumsel" value="<?= @$Fix_Rata_rata_SalesNoType_2_sumsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_3_februari_sumsel" id="txt_Rata_rata_SalesNoType_3_februari_sumsel" value="<?= @$Fix_Rata_rata_SalesNoType_3_sumsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_4_februari_sumsel" id="txt_Rata_rata_SalesNoType_4_februari_sumsel" value="<?= @$Fix_Rata_rata_SalesNoType_4_sumsel ?>" readonly>
  <!-- END FOR SUMSEL -->
<?php
