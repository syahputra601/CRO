...
<h2 style="text-align: center;">Bulan Agustus Tahun <?= @$get_year_filter ?></h2>
...
foreach($DataCompanyAreaCabang as $row_company){
  ...
  foreach($DataCabang as $row_cabang){
    ...
    //   echo "<br>";
    // }
    $join_month_year = $get_year_filter.'-08';//for Agustus
    // print_r($join_month_year);
    // echo "<br>";
...
if(@$cek_emptydata_new == 0){
  echo "<center><p style='color:red;'>Tidak Ada Laporan Survey Semua Area Pada Bulan Agustus.</p></center>";
//start coding bagian hitung Rata-Rata
  //start for service
...
?>
<!-- START OLD VERSION -->
<input type="hidden" name="txt_Rata_rata_ServiceNoType_1_agustus" id="txt_Rata_rata_ServiceNoType_1_agustus" value="<?= $Fix_Rata_rata_ServiceNoType_1 ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_2_agustus" id="txt_Rata_rata_ServiceNoType_2_agustus" value="<?= @$Fix_Rata_rata_ServiceNoType_2 ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_3_agustus" id="txt_Rata_rata_ServiceNoType_3_agustus" value="<?= @$Fix_Rata_rata_ServiceNoType_3 ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_4_agustus" id="txt_Rata_rata_ServiceNoType_4_agustus" value="<?= @$Fix_Rata_rata_ServiceNoType_4 ?>" readonly>
<br>
<input type="hidden" name="txt_Rata_rata_SalesNoType_1_agustus" id="txt_Rata_rata_SalesNoType_1_agustus" value="<?= @$Fix_Rata_rata_SalesNoType_1 ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_2_agustus" id="txt_Rata_rata_SalesNoType_2_agustus" value="<?= @$Fix_Rata_rata_SalesNoType_2 ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_3_agustus" id="txt_Rata_rata_SalesNoType_3_agustus" value="<?= @$Fix_Rata_rata_SalesNoType_3 ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_4_agustus" id="txt_Rata_rata_SalesNoType_4_agustus" value="<?= @$Fix_Rata_rata_SalesNoType_4 ?>" readonly>
<!-- END OLD VERSION -->
<!-- START BAGIAN TEXT INPUT -->
  <!-- START FOR JAKARTA -->
<input type="hidden" name="txt_Rata_rata_ServiceNoType_1_agustus_jkt" id="txt_Rata_rata_ServiceNoType_1_agustus_jkt" value="<?= $Fix_Rata_rata_ServiceNoType_1_jkt ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_2_agustus_jkt" id="txt_Rata_rata_ServiceNoType_2_agustus_jkt" value="<?= @$Fix_Rata_rata_ServiceNoType_2_jkt ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_3_agustus_jkt" id="txt_Rata_rata_ServiceNoType_3_agustus_jkt" value="<?= @$Fix_Rata_rata_ServiceNoType_3_jkt ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_4_agustus_jkt" id="txt_Rata_rata_ServiceNoType_4_agustus_jkt" value="<?= @$Fix_Rata_rata_ServiceNoType_4_jkt ?>" readonly>
<!-- <br> -->
<input type="hidden" name="txt_Rata_rata_SalesNoType_1_agustus_jkt" id="txt_Rata_rata_SalesNoType_1_agustus_jkt" value="<?= @$Fix_Rata_rata_SalesNoType_1_jkt ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_2_agustus_jkt" id="txt_Rata_rata_SalesNoType_2_agustus_jkt" value="<?= @$Fix_Rata_rata_SalesNoType_2_jkt ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_3_agustus_jkt" id="txt_Rata_rata_SalesNoType_3_agustus_jkt" value="<?= @$Fix_Rata_rata_SalesNoType_3_jkt ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_4_agustus_jkt" id="txt_Rata_rata_SalesNoType_4_agustus_jkt" value="<?= @$Fix_Rata_rata_SalesNoType_4_jkt ?>" readonly>
  <!-- END FOR JAKARTA -->
  <!-- START FOR KALTIM -->
<input type="hidden" name="txt_Rata_rata_ServiceNoType_1_agustus_kaltim" id="txt_Rata_rata_ServiceNoType_1_agustus_kaltim" value="<?= $Fix_Rata_rata_ServiceNoType_1_kaltim ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_2_agustus_kaltim" id="txt_Rata_rata_ServiceNoType_2_agustus_kaltim" value="<?= @$Fix_Rata_rata_ServiceNoType_2_kaltim ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_3_agustus_kaltim" id="txt_Rata_rata_ServiceNoType_3_agustus_kaltim" value="<?= @$Fix_Rata_rata_ServiceNoType_3_kaltim ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_4_agustus_kaltim" id="txt_Rata_rata_ServiceNoType_4_agustus_kaltim" value="<?= @$Fix_Rata_rata_ServiceNoType_4_kaltim ?>" readonly>
<!-- <br> -->
<input type="hidden" name="txt_Rata_rata_SalesNoType_1_agustus_kaltim" id="txt_Rata_rata_SalesNoType_1_agustus_kaltim" value="<?= @$Fix_Rata_rata_SalesNoType_1_kaltim ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_2_agustus_kaltim" id="txt_Rata_rata_SalesNoType_2_agustus_kaltim" value="<?= @$Fix_Rata_rata_SalesNoType_2_kaltim ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_3_agustus_kaltim" id="txt_Rata_rata_SalesNoType_3_agustus_kaltim" value="<?= @$Fix_Rata_rata_SalesNoType_3_kaltim ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_4_agustus_kaltim" id="txt_Rata_rata_SalesNoType_4_agustus_kaltim" value="<?= @$Fix_Rata_rata_SalesNoType_4_kaltim ?>" readonly>
  <!-- END FOR KALTIM -->
  <!-- START FOR KALBAR -->
<input type="hidden" name="txt_Rata_rata_ServiceNoType_1_agustus_kalbar" id="txt_Rata_rata_ServiceNoType_1_agustus_kalbar" value="<?= $Fix_Rata_rata_ServiceNoType_1_kalbar ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_2_agustus_kalbar" id="txt_Rata_rata_ServiceNoType_2_agustus_kalbar" value="<?= @$Fix_Rata_rata_ServiceNoType_2_kalbar ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_3_agustus_kalbar" id="txt_Rata_rata_ServiceNoType_3_agustus_kalbar" value="<?= @$Fix_Rata_rata_ServiceNoType_3_kalbar ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_4_agustus_kalbar" id="txt_Rata_rata_ServiceNoType_4_agustus_kalbar" value="<?= @$Fix_Rata_rata_ServiceNoType_4_kalbar ?>" readonly>
<!-- <br> -->
<input type="hidden" name="txt_Rata_rata_SalesNoType_1_agustus_kalbar" id="txt_Rata_rata_SalesNoType_1_agustus_kalbar" value="<?= @$Fix_Rata_rata_SalesNoType_1_kalbar ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_2_agustus_kalbar" id="txt_Rata_rata_SalesNoType_2_agustus_kalbar" value="<?= @$Fix_Rata_rata_SalesNoType_2_kalbar ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_3_agustus_kalbar" id="txt_Rata_rata_SalesNoType_3_agustus_kalbar" value="<?= @$Fix_Rata_rata_SalesNoType_3_kalbar ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_4_agustus_kalbar" id="txt_Rata_rata_SalesNoType_4_agustus_kalbar" value="<?= @$Fix_Rata_rata_SalesNoType_4_kalbar ?>" readonly>
  <!-- END FOR KALBAR -->
  <!-- START FOR KALSEL -->
<input type="hidden" name="txt_Rata_rata_ServiceNoType_1_agustus_kalsel" id="txt_Rata_rata_ServiceNoType_1_agustus_kalsel" value="<?= $Fix_Rata_rata_ServiceNoType_1_kalsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_2_agustus_kalsel" id="txt_Rata_rata_ServiceNoType_2_agustus_kalsel" value="<?= @$Fix_Rata_rata_ServiceNoType_2_kalsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_3_agustus_kalsel" id="txt_Rata_rata_ServiceNoType_3_agustus_kalsel" value="<?= @$Fix_Rata_rata_ServiceNoType_3_kalsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_4_agustus_kalsel" id="txt_Rata_rata_ServiceNoType_4_agustus_kalsel" value="<?= @$Fix_Rata_rata_ServiceNoType_4_kalsel ?>" readonly>
<!-- <br> -->
<input type="hidden" name="txt_Rata_rata_SalesNoType_1_agustus_kalsel" id="txt_Rata_rata_SalesNoType_1_agustus_kalsel" value="<?= @$Fix_Rata_rata_SalesNoType_1_kalsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_2_agustus_kalsel" id="txt_Rata_rata_SalesNoType_2_agustus_kalsel" value="<?= @$Fix_Rata_rata_SalesNoType_2_kalsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_3_agustus_kalsel" id="txt_Rata_rata_SalesNoType_3_agustus_kalsel" value="<?= @$Fix_Rata_rata_SalesNoType_3_kalsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_4_agustus_kalsel" id="txt_Rata_rata_SalesNoType_4_agustus_kalsel" value="<?= @$Fix_Rata_rata_SalesNoType_4_kalsel ?>" readonly>
  <!-- END FOR KALSEL -->
  <!-- START FOR SUMSEL -->
<input type="hidden" name="txt_Rata_rata_ServiceNoType_1_agustus_sumsel" id="txt_Rata_rata_ServiceNoType_1_agustus_sumsel" value="<?= $Fix_Rata_rata_ServiceNoType_1_sumsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_2_agustus_sumsel" id="txt_Rata_rata_ServiceNoType_2_agustus_sumsel" value="<?= @$Fix_Rata_rata_ServiceNoType_2_sumsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_3_agustus_sumsel" id="txt_Rata_rata_ServiceNoType_3_agustus_sumsel" value="<?= @$Fix_Rata_rata_ServiceNoType_3_sumsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_4_agustus_sumsel" id="txt_Rata_rata_ServiceNoType_4_agustus_sumsel" value="<?= @$Fix_Rata_rata_ServiceNoType_4_sumsel ?>" readonly>
<!-- <br> -->
<input type="hidden" name="txt_Rata_rata_SalesNoType_1_agustus_sumsel" id="txt_Rata_rata_SalesNoType_1_agustus_sumsel" value="<?= @$Fix_Rata_rata_SalesNoType_1_sumsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_2_agustus_sumsel" id="txt_Rata_rata_SalesNoType_2_agustus_sumsel" value="<?= @$Fix_Rata_rata_SalesNoType_2_sumsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_3_agustus_sumsel" id="txt_Rata_rata_SalesNoType_3_agustus_sumsel" value="<?= @$Fix_Rata_rata_SalesNoType_3_sumsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_4_agustus_sumsel" id="txt_Rata_rata_SalesNoType_4_agustus_sumsel" value="<?= @$Fix_Rata_rata_SalesNoType_4_sumsel ?>" readonly>
  <!-- END FOR SUMSEL -->
