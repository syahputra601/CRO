...
<h2 style="text-align: center;">Bulan Maret Tahun <?= @$get_year_filter ?></h2>
...
foreach($DataCompanyAreaCabang as $row_company){
  ...
  foreach($DataCabang as $row_cabang){
    ...
    //   echo "<br>";
    // }
    $join_month_year = $get_year_filter.'-03';//for maret
    // print_r($join_month_year);
    // echo "<br>";
...
if(@$cek_emptydata_new == 0){
  echo "<center><p style='color:red;'>Tidak Ada Laporan Survey Semua Area Pada Bulan Maret.</p></center>";
//start coding bagian hitung Rata-Rata
  //start for service
...
?>
<!-- START VERSION OLD -->
<input type="hidden" name="txt_Rata_rata_ServiceNoType_1_maret" id="txt_Rata_rata_ServiceNoType_1_maret" value="<?= $Fix_Rata_rata_ServiceNoType_1 ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_2_maret" id="txt_Rata_rata_ServiceNoType_2_maret" value="<?= @$Fix_Rata_rata_ServiceNoType_2 ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_3_maret" id="txt_Rata_rata_ServiceNoType_3_maret" value="<?= @$Fix_Rata_rata_ServiceNoType_3 ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_4_maret" id="txt_Rata_rata_ServiceNoType_4_maret" value="<?= @$Fix_Rata_rata_ServiceNoType_4 ?>" readonly>
<!-- <br> -->
<input type="hidden" name="txt_Rata_rata_SalesNoType_1_maret" id="txt_Rata_rata_SalesNoType_1_maret" value="<?= @$Fix_Rata_rata_SalesNoType_1 ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_2_maret" id="txt_Rata_rata_SalesNoType_2_maret" value="<?= @$Fix_Rata_rata_SalesNoType_2 ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_3_maret" id="txt_Rata_rata_SalesNoType_3_maret" value="<?= @$Fix_Rata_rata_SalesNoType_3 ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_4_maret" id="txt_Rata_rata_SalesNoType_4_maret" value="<?= @$Fix_Rata_rata_SalesNoType_4 ?>" readonly>
<!-- END VERSION OLD -->
<!-- START BAGIAN TEXT INPUT -->
  <!-- START FOR JAKARTA -->
<input type="hidden" name="txt_Rata_rata_ServiceNoType_1_maret_jkt" id="txt_Rata_rata_ServiceNoType_1_maret_jkt" value="<?= $Fix_Rata_rata_ServiceNoType_1_jkt ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_2_maret_jkt" id="txt_Rata_rata_ServiceNoType_2_maret_jkt" value="<?= @$Fix_Rata_rata_ServiceNoType_2_jkt ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_3_maret_jkt" id="txt_Rata_rata_ServiceNoType_3_maret_jkt" value="<?= @$Fix_Rata_rata_ServiceNoType_3_jkt ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_4_maret_jkt" id="txt_Rata_rata_ServiceNoType_4_maret_jkt" value="<?= @$Fix_Rata_rata_ServiceNoType_4_jkt ?>" readonly>
<!-- <br> -->
<input type="hidden" name="txt_Rata_rata_SalesNoType_1_maret_jkt" id="txt_Rata_rata_SalesNoType_1_maret_jkt" value="<?= @$Fix_Rata_rata_SalesNoType_1_jkt ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_2_maret_jkt" id="txt_Rata_rata_SalesNoType_2_maret_jkt" value="<?= @$Fix_Rata_rata_SalesNoType_2_jkt ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_3_maret_jkt" id="txt_Rata_rata_SalesNoType_3_maret_jkt" value="<?= @$Fix_Rata_rata_SalesNoType_3_jkt ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_4_maret_jkt" id="txt_Rata_rata_SalesNoType_4_maret_jkt" value="<?= @$Fix_Rata_rata_SalesNoType_4_jkt ?>" readonly>
  <!-- END FOR JAKARTA -->
  <!-- START FOR KALTIM -->
<input type="hidden" name="txt_Rata_rata_ServiceNoType_1_maret_kaltim" id="txt_Rata_rata_ServiceNoType_1_maret_kaltim" value="<?= $Fix_Rata_rata_ServiceNoType_1_kaltim ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_2_maret_kaltim" id="txt_Rata_rata_ServiceNoType_2_maret_kaltim" value="<?= @$Fix_Rata_rata_ServiceNoType_2_kaltim ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_3_maret_kaltim" id="txt_Rata_rata_ServiceNoType_3_maret_kaltim" value="<?= @$Fix_Rata_rata_ServiceNoType_3_kaltim ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_4_maret_kaltim" id="txt_Rata_rata_ServiceNoType_4_maret_kaltim" value="<?= @$Fix_Rata_rata_ServiceNoType_4_kaltim ?>" readonly>
<!-- <br> -->
<input type="hidden" name="txt_Rata_rata_SalesNoType_1_maret_kaltim" id="txt_Rata_rata_SalesNoType_1_maret_kaltim" value="<?= @$Fix_Rata_rata_SalesNoType_1_kaltim ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_2_maret_kaltim" id="txt_Rata_rata_SalesNoType_2_maret_kaltim" value="<?= @$Fix_Rata_rata_SalesNoType_2_kaltim ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_3_maret_kaltim" id="txt_Rata_rata_SalesNoType_3_maret_kaltim" value="<?= @$Fix_Rata_rata_SalesNoType_3_kaltim ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_4_maret_kaltim" id="txt_Rata_rata_SalesNoType_4_maret_kaltim" value="<?= @$Fix_Rata_rata_SalesNoType_4_kaltim ?>" readonly>
  <!-- END FOR KALTIM -->
  <!-- START FOR KALBAR -->
<input type="hidden" name="txt_Rata_rata_ServiceNoType_1_maret_kalbar" id="txt_Rata_rata_ServiceNoType_1_maret_kalbar" value="<?= $Fix_Rata_rata_ServiceNoType_1_kalbar ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_2_maret_kalbar" id="txt_Rata_rata_ServiceNoType_2_maret_kalbar" value="<?= @$Fix_Rata_rata_ServiceNoType_2_kalbar ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_3_maret_kalbar" id="txt_Rata_rata_ServiceNoType_3_maret_kalbar" value="<?= @$Fix_Rata_rata_ServiceNoType_3_kalbar ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_4_maret_kalbar" id="txt_Rata_rata_ServiceNoType_4_maret_kalbar" value="<?= @$Fix_Rata_rata_ServiceNoType_4_kalbar ?>" readonly>
<!-- <br> -->
<input type="hidden" name="txt_Rata_rata_SalesNoType_1_maret_kalbar" id="txt_Rata_rata_SalesNoType_1_maret_kalbar" value="<?= @$Fix_Rata_rata_SalesNoType_1_kalbar ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_2_maret_kalbar" id="txt_Rata_rata_SalesNoType_2_maret_kalbar" value="<?= @$Fix_Rata_rata_SalesNoType_2_kalbar ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_3_maret_kalbar" id="txt_Rata_rata_SalesNoType_3_maret_kalbar" value="<?= @$Fix_Rata_rata_SalesNoType_3_kalbar ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_4_maret_kalbar" id="txt_Rata_rata_SalesNoType_4_maret_kalbar" value="<?= @$Fix_Rata_rata_SalesNoType_4_kalbar ?>" readonly>
  <!-- END FOR KALBAR -->
  <!-- START FOR KALSEL -->
<input type="hidden" name="txt_Rata_rata_ServiceNoType_1_maret_kalsel" id="txt_Rata_rata_ServiceNoType_1_maret_kalsel" value="<?= $Fix_Rata_rata_ServiceNoType_1_kalsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_2_maret_kalsel" id="txt_Rata_rata_ServiceNoType_2_maret_kalsel" value="<?= @$Fix_Rata_rata_ServiceNoType_2_kalsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_3_maret_kalsel" id="txt_Rata_rata_ServiceNoType_3_maret_kalsel" value="<?= @$Fix_Rata_rata_ServiceNoType_3_kalsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_4_maret_kalsel" id="txt_Rata_rata_ServiceNoType_4_maret_kalsel" value="<?= @$Fix_Rata_rata_ServiceNoType_4_kalsel ?>" readonly>
<!-- <br> -->
<input type="hidden" name="txt_Rata_rata_SalesNoType_1_maret_kalsel" id="txt_Rata_rata_SalesNoType_1_maret_kalsel" value="<?= @$Fix_Rata_rata_SalesNoType_1_kalsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_2_maret_kalsel" id="txt_Rata_rata_SalesNoType_2_maret_kalsel" value="<?= @$Fix_Rata_rata_SalesNoType_2_kalsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_3_maret_kalsel" id="txt_Rata_rata_SalesNoType_3_maret_kalsel" value="<?= @$Fix_Rata_rata_SalesNoType_3_kalsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_4_maret_kalsel" id="txt_Rata_rata_SalesNoType_4_maret_kalsel" value="<?= @$Fix_Rata_rata_SalesNoType_4_kalsel ?>" readonly>
  <!-- END FOR KALSEL -->
  <!-- START FOR SUMSEL -->
<input type="hidden" name="txt_Rata_rata_ServiceNoType_1_maret_sumsel" id="txt_Rata_rata_ServiceNoType_1_maret_sumsel" value="<?= $Fix_Rata_rata_ServiceNoType_1_sumsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_2_maret_sumsel" id="txt_Rata_rata_ServiceNoType_2_maret_sumsel" value="<?= @$Fix_Rata_rata_ServiceNoType_2_sumsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_3_maret_sumsel" id="txt_Rata_rata_ServiceNoType_3_maret_sumsel" value="<?= @$Fix_Rata_rata_ServiceNoType_3_sumsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_ServiceNoType_4_maret_sumsel" id="txt_Rata_rata_ServiceNoType_4_maret_sumsel" value="<?= @$Fix_Rata_rata_ServiceNoType_4_sumsel ?>" readonly>
<!-- <br> -->
<input type="hidden" name="txt_Rata_rata_SalesNoType_1_maret_sumsel" id="txt_Rata_rata_SalesNoType_1_maret_sumsel" value="<?= @$Fix_Rata_rata_SalesNoType_1_sumsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_2_maret_sumsel" id="txt_Rata_rata_SalesNoType_2_maret_sumsel" value="<?= @$Fix_Rata_rata_SalesNoType_2_sumsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_3_maret_sumsel" id="txt_Rata_rata_SalesNoType_3_maret_sumsel" value="<?= @$Fix_Rata_rata_SalesNoType_3_sumsel ?>" readonly>
<input type="hidden" name="txt_Rata_rata_SalesNoType_4_maret_sumsel" id="txt_Rata_rata_SalesNoType_4_maret_sumsel" value="<?= @$Fix_Rata_rata_SalesNoType_4_sumsel ?>" readonly>
  <!-- END FOR SUMSEL -->
